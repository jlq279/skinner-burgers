            ...
            if (mouse.buttons == 1) {
                ...
                if (this.first) {
                    ...
                    if (disc >= 0) {
                        ...
                        console.log("t " + t);
                        var newend = Vec3.sum(p, v.scale(t, temp2));
                        var newendloc = Vec3.difference(newend, j);
                        var curendloc = Vec3.difference(curend, j);
                        ...
                        var cq = nq.multiply(this.animation.getScene().meshes[0].bones[intersection[1]].rotation, temp5);
